...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>rst</b></em>'
 * package. <!-- end-user-doc -->
 * 
 * @generated
 */
public class RSTExample {
	/**
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(RSTPackage.eNS_URI, RSTPackage.eINSTANCE);
