...
public abstract class AbstractNodeImpl extends EObjectImpl implements AbstractNode {
	...
	protected EClass eStaticClass() {
		return RSTPackage.Literals.ABSTRACT_NODE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RSTPackage.ABSTRACT_NODE__ID, oldId, id));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RSTPackage.ABSTRACT_NODE__TYPE, oldType, type));
	}
